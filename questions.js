...
const VOCAB_SEED = [
  ...
  ["m1","mid","lunch","점심",["저녁","도서관","숙제"]],
  ["m1","mid","library","도서관",["체육관","식당","교실"]],
  ["m1","mid","teacher","선생님",["학생","교복","과목"]],
  ["m1","mid","homework","숙제",["축제","면접","운동"]],
  ["m1","mid","good at","잘하다",["싫어하다","가르치다","그만두다"]],
  ["m1","mid","turn off","끄다",["켜다","고치다","팔다"]],
  ["m1","high","useful","유용한",["긴장한","유명한","조용한"]],
  ["m1","high","together","함께",["따로","보통","갑자기"]],
  ["m1","high","finish","끝내다",["시작하다","초대하다","미루다"]],
  ["m1","high","invite","초대하다",["소개하다","기억하다","숨기다"]],
  ["m1","high","special","특별한",["평범한","위험한","짧은"]],
  ["m1","high","enough","충분한",["부족한","비싼","늦은"]],
  ["m1","high","share","나누다",["숨기다","버리다","사다"]],
  ["m1","high","quiet","조용한",["시끄러운","더운","어두운"]],

  ["m2","mid","hotel","호텔",["기차","일기","강"]],
  ["m2","mid","diary","일기",["목표","노력","미래"]],
  ["m2","mid","river","강",["문화","직업","청중"]],
  ["m2","mid","train","기차",["발명","존경","성공"]],
  ["m2","mid","run into","우연히 만나다",["달려 피하다","일부러 피하다","크게 싸우다"]],
  ["m2","mid","sold out","매진된",["할인된","무료인","연기된"]],
  ["m2","high","decision","결정",["세대","공동체","공연"]],
  ["m2","high","save","아끼다, 절약하다",["탐험하다","발명하다","만들다"]],
  ["m2","high","original","독창적인",["고대의","현대의","유명한"]],
  ["m2","high","historical","역사적인",["긴장한","신나는","조용한"]],
  ["m2","high","strict","엄격한",["느슨한","유명한","간단한"]],
  ["m2","high","overcome","극복하다",["피하다","숨기다","포기하다"]],
  ["m2","high","available","구할 수 있는",["금지된","비싼","짧은"]],
  ["m2","high","proud of","자랑스러워하다",["부끄러워하다","싫어하다","무시하다"]],

  ["m3","mid","reduce","줄이다",["재활용하다","오염시키다","일으키다"]],
  ["m3","mid","media","매체",["기후","서식지","생물 종"]],
  ["m3","mid","agreement","합의, 협정",["오염","고정관념","정체성"]],
  ["m3","mid","serious","심각한",["유명한","조용한","고대의"]],
  ["m3","mid","take action","조치를 취하다",["구경하다","포기하다","숨기다"]],
  ["m3","mid","unexpected","예상 밖의",["당연한","유명한","간단한"]],
  ["m3","high","protect","보호하다",["오염시키다","재활용하다","멸종하다"]],
  ["m3","high","support","지지, 지원",["편견","서식지","기후"]],
  ["m3","high","consume","소비하다",["재활용하다","보호하다","줄이다"]],
  ["m3","high","raise","제기하다",["숨기다","무시하다","복사하다"]],
  ["m3","high","biased","편향된",["공정한","유명한","짧은"]],
  ["m3","high","sustainable","지속 가능한",["일회용의","불법의","비밀의"]],
  ["m3","high","harm","해치다",["돕다","숨기다","측정하다"]],
  ["m3","high","cooperate","협력하다",["경쟁하다","무시하다","분리하다"]],

  ["h1","mid","explain","설명하다",["요구하다","증가하다","마련하다"]],
  ["h1","mid","solve","해결하다",["발생하다","향상시키다","제공하다"]],
  ["h1","mid","contain","포함하다",["제외하다","숨기다","빼앗다"]],
  ["h1","mid","typical","전형적인",["꺼리는","불가피한","끊임없는"]],
  ["h1","mid","related","관련된",["반대의","비밀의","임시의"]],
  ["h1","mid","offer","제시하다",["거절하다","숨기다","취소하다"]],
  ["h1","high","gradual","점진적인",["유명한","긴장한","고대의"]],
  ["h1","high","follow","지키다, 따르다",["발생하다","마련하다","감사하다"]],
  ["h1","high","data","자료, 데이터",["의견","교복","축제"]],
  ["h1","high","primary","주된, 일차적인",["꺼리는","유명한","조용한"]],
  ["h1","high","temporary","일시적인",["영원한","유명한","불법의"]],
  ["h1","high","objective","객관적인",["감정적인","유명한","임시의"]],
  ["h1","high","consistent","일관된",["모순된","비밀의","사소한"]],
  ["h1","high","reject","거절하다",["수락하다","숨기다","복사하다"]],

  ["h2","mid","persuade","설득하다",["분석하다","줄어들다","발명하다"]],
  ["h2","mid","concept","개념",["청중","교복","축제"]],
  ["h2","mid","compare","비교하다",["오염시키다","초대하다","재활용하다"]],
  ["h2","mid","similar","비슷한",["고대의","긴장한","조용한"]],
  ["h2","mid","verify","검증하다",["부정하다","숨기다","복사하다"]],
  ["h2","mid","relevant","관련 있는",["무관한","유명한","임시의"]],
  ["h2","high","tentative","잠정적인",["유명한","고대의","조용한"]],
  ["h2","high","control","통제하다",["초대하다","재활용하다","여행하다"]],
  ["h2","high","acknowledge","인정하다",["오염시키다","발명하다","숨기다"]],
  ["h2","high","misleading","오해하게 하는",["유명한","친절한","짧은"]],
  ["h2","high","negligible","무시할 만한",["중대한","유명한","불법의"]],
  ["h2","high","flawed","결함 있는",["완벽한","유명한","짧은"]],
  ["h2","high","cite","인용하다",["숨기다","부정하다","복사하다"]],
  ["h2","high","ironic","반어적인",["문자 그대로의","친절한","공식적인"]],

  ["h3","mid","widen","넓히다",["재활용하다","초대하다","여행하다"]],
  ["h3","mid","criterion","기준",["축제","교복","취미"]],
  ["h3","mid","confirm","확인하다, 입증하다",["숨기다","초대하다","오염시키다"]],
  ["h3","mid","extreme","극단적인",["유명한","조용한","친절한"]],
  ["h3","mid","irreversible","되돌릴 수 없는",["일시적인","유명한","간단한"]],
  ["h3","mid","dismiss","일축하다",["수용하다","숨기다","복사하다"]],
  ["h3","high","insufficient","불충분한",["유명한","고대의","친절한"]],
  ["h3","high","minimize","최소화하다",["초대하다","재활용하다","여행하다"]],
  ["h3","high","crucial","결정적으로 중요한",["긴장한","조용한","고대의"]],
  ["h3","high","unintended","의도하지 않은",["유명한","친절한","짧은"]],
  ["h3","high","unfounded","근거 없는",["확실한","유명한","짧은"]],
  ["h3","high","obsolete","낡은, 쓸모없는",["최신의","유명한","불법의"]],
  ["h3","high","advocate","옹호하다",["반대하다","숨기다","복사하다"]],
  ["h3","high","prohibitive","감당하기 어려운",["아주 싼","유명한","비밀의"]]
];
